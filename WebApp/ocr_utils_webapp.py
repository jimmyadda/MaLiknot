    ...
    try:
        response = openai_client.chat.completions.create(
            ...
            messages=[
                {
                    "role": "system",
                    "content":"אתה מזהה ומנקה טקסט מתמונה של רשימת קניות בכתב יד בעברית. "
                                "תחזיר רק את שמות המוצרים שניתן לקרוא בוודאות, מופרדים בפסיקים. "
                                "אם מילה לא ברורה, אל תמציא — פשוט דלג עליה."
                },
                {
                    "role": "user",
                    "content": [
